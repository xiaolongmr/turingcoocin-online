...
var themeManager = (function () {
    ...
    function updateThemeWithAppSkinInfo(appSkinInfo) {
		...
		if (isLight) {
		  $("#theme").attr("href", "../styles/topcoat-desktop-light.min.css");
		  $("#themeMe").attr("href", "../styles/mainStyles-light.css");
		} else {
		  $("#theme").attr("href", "../styles/topcoat-desktop-dark.min.css");
		  $("#themeMe").attr("href", "../styles/mainStyles-dark.css");
		}
    ...
    function onAppThemeColorChanged(event) {
		...
		showTipsBar("更改主题|云乐脚本坞|"+H5IMG.TIP);	
    }
